...
class ImageExtension():
    ...
    cache_dir =  "C:/Users/23222/.cache/huggingface/hub/"  # diffusers的本地缓存路径
    ...
    def sample_block(self, latent: torch.Tensor, masked_latent: torch.Tensor, mask: torch.Tensor,
                     prompt_embeds: torch.Tensor, timestep: torch.Tensor, guidance_scale: int = 7):
    ...
    def sample(self, latent: torch.Tensor, masked_latent: torch.Tensor, mask: torch.Tensor, chunk_list: List[int],
               prompt_embeds: torch.Tensor, guidance_scale: int = 7):
    ...
    def load_scheduler(self):
        ...
        #
        # self.ddim.set_timesteps(self.sampleTimeStep, device=0)
